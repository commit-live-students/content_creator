...
This is the [link](https://github.com/commit-live-students/content_creator/blob/master/greyatom_reference_notebooks/linear_regression_concept_reference/notebooks/linear_regression_concept_reference_notebook.ipynb) to the sample reference content.  
